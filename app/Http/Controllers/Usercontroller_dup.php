...
class UserController extends BaseController
{
    ...
    public function getDashboard()
    {
      //print_r(session('timegenerated').'-'.time());die();
        ...
        $homePageUrl = "https://app.powerbi.com/groups/b962df5a-da74-4a57-8cd5-9d751a9fd539/reports/08c60490-ae76-431c-98dd-4334ed71e2a2/ReportSection8dfe45042d52b5d217ee";
	...
	public function regenToken()
    {
      ...
      curl_setopt($ch, CURLOPT_POST, 1);
       curl_setopt($ch, CURLOPT_POSTFIELDS,
                   "client_id=42283739-1b72-4a4c-af9e-6655ea649bd6&client_secret=kgR24]Ian9-M./7LoiODZ1FRb8rBv[=h&username=suntech.powerbi@kiteservices.com&password=Zuy71742&resource=https://analysis.windows.net/powerbi/api&grant_type=password&scopes=openid");
    // curl_setopt($ch, CURLOPT_POSTFIELDS,
    //               "client_id=84ae1366-2c44-41d1-82ee-4666f617c561&client_secret=xb].-=EFcS2aED48la8s03zNEvtw.1S3&username=suntech.powerbi@kiteservices.com&password=Zuy71742&resource=https://analysis.windows.net/powerbi/api&grant_type=password&scopes=openid");
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/x-www-form-urlencoded'));
      ...
      if(!isset($responses['access_token'])){
          ...
          exit();
        //return redirect()->with($responses['error'], $responses['error_description']);
        // return redirect('/user/logouts')
        // ->with('error', $responses['error'])
        // ->with('errorDetail', $responses['error_description']);
        
      }
    //   if(isset($responses['error']) && $responses['error'] == 'invalid_grant'){
    //        redirect('/login')->with('error', 'Invalid Token')
    //           ->with('errorDetail', 'Security Reason Service Not availabe for this account ');
    //   }

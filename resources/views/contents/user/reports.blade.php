                  ...
                  <div class="col-lg-12 col-xl-12">
                     <div class="card" id="main__tab">
                        <ul class="nav nav-tabs md-tabs" role="tablist">
                           ...
                           <li class="nav-item">
                              <a class="tublue nav-link @if($l == 1){{ 'active' }}@endif" data-toggle="tab" href="#tab{{ $tab->category_id }}" role="tab"
                                          ...
                                          <div class="accordion-desc">
                                             <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 category__tabs sublue{{$category->category_id}}" >
                                                ...
                                                <div class="tab-content tabs-left-content card-block" style="width: 100%;">
                                                   ...
                                                   @endphp
                                                   <div class="tab-pane @if($k == 1){{ 'active' }}@endif" id="category{{ $category->category_id }}" role="tabpanel" style="height: 600px">
                                                      @if($k == 1)
                                                      <div class="row">
...
<script>
   ...
   function reportTabLoader(category_id)
   {
      ...
      if(token !==null)
      {
       ...
       $.ajax({
           url: '<?php echo e(env("APP_URL")); ?>getcategorydata',
           type: 'GET',
           headers: {
